...
def grapher(genders_to_show, units, input_x, input_y, measurement_x, measurement_y):
    ...
    measurement1 = funcs.linker2(measurement_x.lower())             
    measurement2 = funcs.linker2(measurement_y.lower())                    
    ...
    dataf = funcs.ratio_gen2(measurement1, measurement2, "ansur2_female.csv")
    datam = funcs.ratio_gen2(measurement1, measurement2, "ansur2_male.csv")
